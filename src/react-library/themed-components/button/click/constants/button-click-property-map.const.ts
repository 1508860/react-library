...
import type { IButtonClickPropertyMap } from "../interfaces/button-click-property-map.interface";

/**
 * Constant values for button click style sizes
 */
export const BUTTON_CLICK_PROPERTY_MAP: IButtonClickPropertyMap = {
	size: {
