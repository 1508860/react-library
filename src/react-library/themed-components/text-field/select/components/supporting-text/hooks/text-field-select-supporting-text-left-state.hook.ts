...
/**
 * Custom hook to resolve the left config for supporting text for a select input
 * @param props
 */
export function useTextFieldSelectSupportingTextLeftState<TId extends TextFieldSelectItemId>(
	props: TextFieldSelectProps<TId>
): TextFieldSupportingTextConfigsLeft {
