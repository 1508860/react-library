...
/**
 * Custom hook to resolve the left config for supporting text for a date input
 * @param props
 */
export function useTextFieldDateSupportingTextLeftState(props: TextFieldDateProps): TextFieldSupportingTextConfigsLeft {
