...
/**
 * Custom hook to resolve the left config for supporting text for a number input
 */
export function useTextFieldNumberSupportingTextLeftState(props: TextFieldNumberProps): TextFieldSupportingTextConfigsLeft {
