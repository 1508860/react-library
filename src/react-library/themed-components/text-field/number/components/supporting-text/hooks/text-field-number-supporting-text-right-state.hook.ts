...
/**
 * Custom hook to resolve the right config for supporting text for a number input
 */
export function useTextFieldNumberSupportingTextRightState(props: TextFieldNumberProps): TextFieldSupportingTextConfigsRight {
