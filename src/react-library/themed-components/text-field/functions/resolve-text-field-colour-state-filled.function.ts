...
/**
 * Resolve {@link TextFieldColourState} for a filled style text field
 * @param styleState
 * @param colourScheme
 */
export function resolveTextFieldColourStateFilled(styleState: TextFieldStyleState, colourScheme: ColourScheme): TextFieldColourState {
	switch (styleState) {
