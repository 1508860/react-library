...
/**
 * Resolve {@link TextFieldColourState} for an outlined style text field
 * @param styleState
 * @param colourScheme
 */
export function resolveTextFieldColourStateOutlined(styleState: TextFieldStyleState, colourScheme: ColourScheme): TextFieldColourState {
	switch (styleState) {
		...
		case TextFieldStyleState.Errored: return {
			...
			leadingIcon: colourScheme.surface.variant.onColour,
			supportingText: colourScheme.error.default.colour,
			text: colourScheme.surface.variant.onColour,
