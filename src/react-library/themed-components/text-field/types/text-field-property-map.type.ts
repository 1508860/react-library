...
export type TextFieldPropertyMap = (
	IContent<Record<TextFieldContent, (TextFieldPropertyContentMap | undefined)>> &
	IStyle<Record<TextFieldStyle, TextFieldPropertyStyleMap>>
);

/**
 * Describes values for text field style sizes for a {@link TextFieldContent}
 */
export type TextFieldPropertyContentMap = (
	IExtraTextPosition<Record<TextFieldExtraTextPosition, (TextFieldPropertyContentExtraTextPositionMap | undefined)>>
);

type TextFieldPropertyContentExtraTextPositionMap = (
	ITextAlign<Property.TextAlign>
);
