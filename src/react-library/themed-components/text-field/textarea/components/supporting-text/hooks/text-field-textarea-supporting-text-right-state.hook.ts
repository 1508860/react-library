...
/**
 * Custom hook to resolve the right config for supporting text for a textarea
 */
export function useTextFieldTextareaSupportingTextRightState(props: TextFieldTextareaProps): TextFieldSupportingTextConfigsRight {
