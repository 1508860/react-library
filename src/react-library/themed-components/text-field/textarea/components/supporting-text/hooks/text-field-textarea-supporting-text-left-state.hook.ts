...
/**
 * Custom hook to resolve the left config for supporting text for a textarea
 */
export function useTextFieldTextareaSupportingTextLeftState(props: TextFieldTextareaProps): TextFieldSupportingTextConfigsLeft {
