...
/**
 * Custom hook for a {@link DateTimeValue} to be formatted to a display time for a given {@link TimeDisplayStyle} and {@link DateTimeDisplayLength}
 * @param value
 * @param timeDisplayStyle
 * @param length
 */
export function useTimeDisplayState(value: DateTimeValue, timeDisplayStyle: TimeDisplayStyle, length: DateTimeDisplayLength): [DateTimeDisplayState] {
