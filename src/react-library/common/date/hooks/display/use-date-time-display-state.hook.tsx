...
/**
 * Custom hook for a {@link DateTimeValue} to be formatted to a display date time for a given {@link TimeDisplayStyle} and {@link DateTimeDisplayLength}
 * The date style is assumed to be {@link DateDisplayStyle.Day} as a full date time requires a full date
 * @param value
 * @param timeDisplayStyle
 * @param length
 */
export function useDateTimeDisplayState(value: DateTimeValue, timeDisplayStyle: TimeDisplayStyle, length: DateTimeDisplayLength): [DateTimeDisplayState] {
