...
/**
 * Describes a postion strategy of bottom end
 */
export type PositionStrategyExternalBottomEnd<TMarginTop extends Size> = (
	Partial<IMarginTop<TMarginTop>> &
	PositionStrategyExternalBase<typeof PositionStrategyExternal.BottomEnd>
);
