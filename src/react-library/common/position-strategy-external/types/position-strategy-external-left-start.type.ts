...
/**
 * Describes a postion strategy of left start
 */
export type PositionStrategyExternalLeftStart<TMarginRight extends Size> = (
	Partial<IMarginRight<TMarginRight>> &
	PositionStrategyExternalBase<typeof PositionStrategyExternal.LeftStart>
);
