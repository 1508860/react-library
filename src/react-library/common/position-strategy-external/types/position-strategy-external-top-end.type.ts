...
/**
 * Describes a postion strategy of top end
 */
export type PositionStrategyExternalTopEnd<TMarginBottom extends Size> = (
	Partial<IMarginBottom<TMarginBottom>> &
	PositionStrategyExternalBase<typeof PositionStrategyExternal.TopEnd>
);
