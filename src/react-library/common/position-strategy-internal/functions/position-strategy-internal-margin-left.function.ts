 ...
 */
export function positionStrategyInternalMarginLeft<TMarginLeft extends Size>(
	positionStrategy: PositionStrategyInternalAll<TMarginLeft, Size>
): TMarginLeft | undefined {
