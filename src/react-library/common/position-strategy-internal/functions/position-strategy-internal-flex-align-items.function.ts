...
/**
 * Resolve {@link CSS.Property.AlignItems} value for {@link positionStrategyType} and a {@link flexDirection}
 * @param positionStrategyType
 * @param flexDirection
 */
export function positionStrategyInternalFlexAlignItems(
	positionStrategyType: PositionStrategyInternal,
	flexDirection: Extends<Property.FlexDirection, ("column" | "row")>
): Extends<Property.AlignItems, ("start" | "center" | "end")> {
