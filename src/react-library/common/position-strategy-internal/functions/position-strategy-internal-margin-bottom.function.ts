 ...
 */
export function positionStrategyInternalMarginBottom<TMarginBottom extends Size>(
	positionStrategy: PositionStrategyInternalAll<Size, TMarginBottom>
): TMarginBottom | undefined {
